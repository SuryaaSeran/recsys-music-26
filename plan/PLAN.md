...
```
0.1519  v6 fusion (TT+CF+Qm+Ql+CLAP+BM25), v13_tuned weights, BM25@500 pool   <- current best
0.1518  v6 fusion + recall expansion (artist + TT@1000), bm25_floor=0.05      <- parity, no gain
