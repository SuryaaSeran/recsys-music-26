...
\begin{table}
  ...
  \label{tab:sources}
  \begin{tabular}{p{0.04\linewidth}p{0.20\linewidth}p{0.16\linewidth}p{0.48\linewidth}}
    \toprule
...
LambdaMART-only baseline (Table~\ref{tab:rerank-fail}). A pre-trained
...
\begin{table}
  \caption{Reranking attempts on top of the LambdaMART baseline.}
  \label{tab:rerank-fail}
  \begin{tabular}{p{0.28\linewidth}p{0.32\linewidth}p{0.28\linewidth}}
    ...
    Gemma-3-12b conservative pruning (25$\to$20) & 0.0812 vs. 0.0818 baseline & regression \\
    Zero-shot Qwen3-8B reranker & Blind A nDCG@20 0.3990$\to$0.3310, lex. div. 0.5909$\to$0.0125, judge 1.90$\to$1.15, composite 0.3291$\to$0.1811 & diversity collapse \\
    \bottomrule
  \end{tabular}
\end{table}
