"""Package the corrected v5-cand (no-bucket) Blind B submission zip.

prediction.json = exp/inference/blind_b/blind_b_v8d_tier1_nobucket_resp_v2.json
zip at exp/inference/blind_b/submissions/v5cand_v2_v8d_tier1_nobucket/submission.zip
"""
import json
import shutil
import zipfile
...
src = ROOT / "exp/inference/blind_b/blind_b_v8d_tier1_nobucket_resp_v2.json"
outdir = ROOT / "exp/inference/blind_b/submissions/v5cand_v2_v8d_tier1_nobucket"
