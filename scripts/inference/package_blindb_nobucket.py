"""Package the no-bucket Blind B candidate submission zip.

prediction.json = exp/inference/blind_b/blind_b_v8d_tier1_nobucket_resp.json
zip at exp/inference/blind_b/submissions/v5cand_v8d_tier1_nobucket/submission.zip
"""
import json
import shutil
import zipfile
...
src = ROOT / "exp/inference/blind_b/blind_b_v8d_tier1_nobucket_resp.json"
outdir = ROOT / "exp/inference/blind_b/submissions/v5cand_v8d_tier1_nobucket"
